...
export function log(isMobile: boolean | 'main', title: string, message: string, webhookBool: boolean = false, type: 'log' | 'warn' | 'error' = 'log', color?: keyof typeof chalk): void {
    /*
    ...
    */
    ...
    if (cleanStr && webhookBool) Webhook(cleanStr)
